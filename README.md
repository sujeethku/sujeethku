...
- **Vibe coding as a PM**  
  Applying a rapid-prototyping workflow where LLMs act as an engineering multiplier — allowing me to turn product ideas into functional prototypes, validate concepts quickly, and iterate with real user interactions.

- **AI, RAG, and Agentic product capabilities**  
  Deepening practical intuition for how LLMs, retrieval systems, and agentic architectures influence product strategy, quality benchmarks, system design, and user experience. I actively build small end-to-end solutions to better understand real-world constraints and opportunities.

- **Building tools the way PMs think**  
  Designing lightweight apps that combine clean UX, structured workflows, and simple data pipelines. Each project strengthens my ability to translate ambiguous problems into technical scoping, evaluation frameworks, and working features, even with minimal coding requirements.

- **Expanding a portfolio of practical AI-powered apps**  
  Continuously shipping compact, useful tools in Python and lightweight web frameworks. These projects serve as hands-on learning environments to explore AI interventions, automate tasks, and prototype product ideas at speed.
...
- **Start with a real problem**  
  Every project begins with a clear pain point, something I personally experience or observe in users.

- **Define a minimal, meaningful scope**  
  I avoid “demo code” and instead build the smallest version that delivers a real outcome or insight.

- **Prototype fast using vibe coding**  
  I use LLMs as an engineering accelerator, combining product instincts with guided implementation to ship quickly.

- **Design with usability in mind**  
  Even early prototypes include clean workflows, intuitive UX, and clear separation of logic and data.

- **Learn through iteration**  
  Each feature adds a new layer of technical exposure, whether it's data modeling, routing, validation, or AI integration.
...
- LinkedIn: *www.linkedin.com/in/sujeethku*
- Medium: *https://medium.com/@sujeethku*

Always happy to discuss product design, applied AI/ML, and the emerging workflows that help PMs think, prototype, and build with greater technical depth.
